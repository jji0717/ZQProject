...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/ScheduledTV_new/MAINCTRL/ScheduleTVServ.h $
// 
...
public:
	...
	static DWORD		m_dwTrace;
	static wchar_t		m_wszTraceFile[MAX_PATH];

	// P&PM vars
	static wchar_t		m_wszMirrorPath[MAX_PATH];
	static DWORD		m_dwFillLength;
	static DWORD		m_dwMaxSubChannel;
	static DWORD		m_dwLastChanceNPT;
	static DWORD		m_dwPenaltyIncrRate;
