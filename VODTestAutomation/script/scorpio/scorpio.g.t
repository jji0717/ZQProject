...
[ ] //  NAME:					  SCORPIO.T
[ ] //
[ ] //  DESCRIPTION:		Data-driven test script for creating and verifying assets.
[ ] //
[ ] //  $HISTORY:$
[ ] //
[ ] //*****************************************************************************
...
[-] // *** DATA DRIVEN ASSISTANT Section (!! DO NOT REMOVE !!) ***
	...
	[ ] 
	[ ] // *** DSN ***
	[ ] STRING gsDSNConnect = "DSN=Segue DDA Excel;DBQ="+csInstallPath+"zodiac\ctl\scorpio\scorpiocfg.xls;UID=;PWD=;"
	[ ] 
	[ ] // *** Global record for each testcase ***
	[ ] 
	[-] type REC_DATALIST_DD_tcCreateAsset0001 is record
	...
	[-] type REC_Sheet1_ is record
		...
		[ ] STRING AeName1  //AeName1, 
		[ ] STRING AssetActivate  //AssetActivate, 
		[ ] STRING AssetDeactivate  //AssetDeactivate, 
		[ ] STRING AeActivate  //AeActivate, 
		[ ] STRING AeDeactivate  //AeDeactivate, 
		[ ] STRING AeDelete  //AeDelete, 
		[ ] STRING AeRelease  //AeRelease, 
		[ ] STRING AeUpload  //AeUpload, 
		[ ] STRING Folder  //Folder, 
		[ ] STRING ContentPath  //ContentPath, 
		[ ] STRING ContentFileName1  //ContentFileName1, 
	[ ] 
	...
	[-] REC_Sheet1_ grTest_Sheet1_ = {...}
		[ ] "1,SeaChange Movies On Demand" // Application
		[ ] "2,ScorpioAsset" // AssetName1
		[ ] "3,ScorpioAe" // AeName1
		[ ] "0,5,01/01/01 00:00:00" // AssetActivate
		[ ] "0,5,12/30/10 00:00:00" // AssetDeactivate
		[ ] "0,5,01/01/01 00:00:00" // AeActivate
		[ ] "0,5,12/30/10 00:00:00" // AeDeactivate
		[ ] "0,5,12/31/10 00:00:00" // AeDelete
		[ ] "0,5,01/01/01 00:00:00" // AeRelease
		[ ] "0,5,01/01/01 00:00:00" // AeUpload
		[ ] "\SeaChange Movies On Demand\Scorpio" // Folder
		[ ] "\\192.168.12.11\d$\ServiceTest\" // ContentPath
		[ ] "ad30s.mpg" // ContentFileName1
	[ ] 
...
[-] main()
	...
	[ ] DD_tcCreateAsset0001({grTest_Sheet1_})
[ ] 
[-] testcase DD_tcCreateAsset0001 (REC_DATALIST_DD_tcCreateAsset0001 rData) appstate BaseState
	[ ] 
	...
	[ ] sAssetName1 = rData.recSheet1_.AssetName1
	[ ] sAeName1 = rData.recSheet1_.AeName1
	...
	[ ] sAActiveTime = rData.recSheet1_.AssetActivate
	[ ] sADeactiveTime = rData.recSheet1_.AssetDeactivate
	...
	[ ] sAeActiveDate = rData.recSheet1_.AeActivate
	[ ] sAeDeactiveDate = rData.recSheet1_.AeDeactivate
	[ ] sAeDeleteDate = rData.recSheet1_.AeDelete
	[ ] sAeContentName1 = rData.recSheet1_.ContentFileName1
	[ ] sAeContentPath = rData.recSheet1_.ContentPath
	[ ] sAeReleaseDate = rData.recSheet1_.AeRelease
	[ ] sAeUploadDate = rData.recSheet1_.AeUpload
	[ ] 
	...
	[ ] sAssetFolder = rData.recSheet1_.Folder
