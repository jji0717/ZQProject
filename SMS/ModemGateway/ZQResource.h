...
#define ZQ_PRODUCT_VER_STR1		"1.0.7.0"
#define ZQ_PRODUCT_VER_STR2		"1.0.7.0"
...
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"ModemGateway_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"ModemGateway"
#endif // _DEBUG
