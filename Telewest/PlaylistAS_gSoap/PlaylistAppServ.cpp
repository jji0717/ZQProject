...
// Revision History:
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/Telewest/PlaylistAS_gSoap/PlaylistAppServ.cpp $
// 
...
// Created.
// 
// 2     09-08-04 11:03 Build
// comment not used configuration
// 
...
HRESULT PlaylistAppServ::OnInit()
{
	...
	try
	{
		...
		// following configuration are not used anymore
/*		dwNum = MAX_PATH*2;
...
*/
		glog(Log::L_INFO,L"********************************************************");
		glog(Log::L_INFO,L"*             PlaylistAS %s                 *", m_wszVerInfo);
		glog(Log::L_INFO,L"********************************************************");
