...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(ZQProjsPath)\Common" /I "$(ITVSDKPATH)\include" /I "$(GSOAPPATH)" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_UNICODE" /D "UNICODE" /D "_AFXDLL" /FR /FD /c
# SUBTRACT CPP /YX /Yc /Yu
# ADD BASE RSC /l 0x804 /d "NDEBUG"
# ADD RSC /l 0x804 /i "$(GSOAPPATH)" /i "$(ZQPROJSPATH)/build" /i "$(ITVSDKPATH)" /d "NDEBUG"
BSC32=bscmake.exe
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(ZQProjsPath)\Common" /I "$(ITVSDKPATH)\include" /I "$(GSOAPPATH)" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_UNICODE" /D "UNICODE" /D "_AFXDLL" /FR /FD /GZ /c
# SUBTRACT CPP /YX /Yc /Yu
# ADD BASE RSC /l 0x804 /d "_DEBUG"
# ADD RSC /l 0x804 /i "$(ZQPROJSPATH)/build" /i "$(ITVSDKPATH)" /i "$(GSOAPPATH)" /d "_DEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
...
SOURCE=.\SoapImplC.cpp
# End Source File
# Begin Source File

SOURCE=.\SoapImplClient.cpp
# End Source File
# Begin Source File

SOURCE="$(GSOAPPATH)\stdsoap2.cpp"
# End Source File
# Begin Source File
...
SOURCE=.\SoapImplSoapWrapProxy.h
# End Source File
# Begin Source File

SOURCE=.\SoapImplStub.h
# End Source File
# Begin Source File

SOURCE=.\SoapInterface.h

!IF  "$(CFG)" == "PlaylistAS - Win32 Release"

# Begin Custom Build
InputPath=.\SoapInterface.h

"SoapImplPlaylistSoapInterfaceSoapBindingProxy.h SoapImplStub.h SoapImplC.cpp SoapImplH.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	.\soapcpp2.exe -p SoapImpl "$(InputPath)"
