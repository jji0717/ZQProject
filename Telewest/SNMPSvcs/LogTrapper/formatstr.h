...
//get formated string with format style in strFmtStr 
// for example: if the strFmtStr is "%1 Love %2", and the other paraments are "AiShangXiaoBai" and "XiaoBai"
// it will return "AiShangXiaoBai Love XiaoBai"
std::string FormatString(const char* strFmtStr, ...);

//get formated string with format style in strFmtStr 
// for example: if the strFmtStr is "%1 Love %2", the arrParament[0] = "AiShangXiaoBai" and arrParament[1] = "XiaoBai"
// it will return "AiShangXiaoBai Love XiaoBai"
