...
#define ZQ_PRODUCT_VER_STR1		"1.0.8.0"
#define ZQ_PRODUCT_VER_STR2		"1,0,8,0"
#define ZQ_PRODUCT_VER_STR3		"V1.0.8 (build 1)"

// the following section are static per-project
#define ZQ_PRODUCT_NAME			"MOD Plug-in"
#define ZQ_FILE_DESCRIPTION        	"Authorization"
#ifdef _DEBUG
#define ZQ_FILE_NAME               	"Authorization_d.dll"
#define ZQ_INTERNAL_FILE_NAME      	"Authorization_d"
#else
#define ZQ_FILE_NAME               	"Authorization.dll"
#define ZQ_INTERNAL_FILE_NAME      	"Authorization"
#endif
