...
#define ZQ_PRODUCT_NAME				"SeaChange DODDevKit DLL"
...
#define ZQ_FILE_DESCRIPTION        	"SeaChange DODDevKit DLL"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"DODDevKit_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"DODDevKit"
#endif // _DEBUG
