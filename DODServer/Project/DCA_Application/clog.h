...
extern "C" bool FileExists( LPCTSTR lpszFilename );
extern "C" BOOL FileCopy(CString SrcFileName, CString DstFileName); 
extern "C" BOOL DirectoryExist(LPCTSTR lpszpathame,LPCTSTR lpszFilename);
extern "C" bool DeleteDirectory(char* DirName);