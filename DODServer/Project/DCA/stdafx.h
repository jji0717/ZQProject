...
V2,1,1,2	2006.07.31	zhenan_ji   1.change version number equal to release version number;
	
V2,1,1,3	2006.07.31	zhenan_ji   1.Parse a message if its groupID is zero;it will send all channel of respond dataType;
V2,1,1,4	2006.08.23	zhenan_ji   1.Improve :moveAllFile ,deletedirectory, 
									2.modified interface of DevKit: SetSRMAdd();
			2006.09.04	zhenan_ji	1.change createThread to afxbeginthread in RunThread(DCA.cpp)
V2,1,1,5	2006.09.12	zhenan_ji   1.Add connection.stop to JMS.cpp.When DCA service stops ,the first jms.connection should stop .
									2.Add log_info and log_detail to two thread.
									3.Add wait thread exit to a thread of channel.
									4.Remove all no use code and test code and variable.
									5.Add log level into DCA.xml.Setting default loglevel is log_debug.
...
#define LOG_DEBUG	 30
#define LOG_INFO	 40
#define LOG_DETAIL	 50
#define LOG_All		 100
#define LOGMAXSIZE  (128*1024*1024)     //128M or 64M
