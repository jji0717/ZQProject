...
// create index table or not by destionation name of message's content.
	...
	//Add Message to List
	void  AddMsgList(ZQCMessageInfoTINF *pinfo);
	
	//For message fomrat 
	COleDateTime m_LastUpdateTime;
   //For message fomrat ,message channel Update Time
...
//queue name ,in sending message, it will be used.
	...
	int FullPathModified(CString remotePath,int UpdateMode,CString subPath);
