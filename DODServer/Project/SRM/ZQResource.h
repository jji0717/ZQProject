...
#define ZQ_PRODUCT_NAME				"SeaChange DOD SRM Service"
...
#define ZQ_FILE_DESCRIPTION        	"SeaChange DOD SRM Service"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"DSA_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"SRM"
#endif // _DEBUG
