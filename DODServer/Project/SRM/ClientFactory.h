...
#ifndef ClientFactoryH
#define ClientFactoryH
...
public: //attribute
	...
	//static CClientFactory* s_SingleConnect;
    static CClientFactory* s_ClientFactory;
	//CSCTCPSocket m_Socket;
	bool m_bConnected;
	//int m_iStatus;			// thread status 0 no running 1 running 2  3 quit
    CClientFactory(CDSAResource* pOwner)
	{
		//initial thread
        m_pOwner=pOwner;
		m_Thread = NULL;
