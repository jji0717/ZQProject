...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/MulticastForwarding/McastTest/McastSnfr2.cpp $
// 
...
//	printf("\t-d   the number of the dispatcher threads\n");
...
//	denyTest();
	...
	char ch;
	while((ch = getopt(argc, argv, "hg:p:b:t:d:s")) != EOF)
	{
		switch (ch)
		{
		case '?':
