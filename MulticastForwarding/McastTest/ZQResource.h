...
#define ZQ_FILE_DESCRIPTION        	"Multicast Forwarding Test Utility"
#ifdef _DEBUG
#define ZQ_FILE_NAME               	"McastFwdUtil_d.exe"
#define ZQ_INTERNAL_FILE_NAME      	"McastFwdUtil_d_d"
#else
#define ZQ_FILE_NAME               	"McastFwdUtil.exe"
#define ZQ_INTERNAL_FILE_NAME      	"McastFwdUtil"
#endif
