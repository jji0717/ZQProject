...
AssetModule::AssetFactory::anAsset_def * 
AssetFactory_impl::anAsset ()
...
void 
AssetFactory_impl::anAsset ( const AssetModule::AssetFactory::anAsset_def & anAsset)
    throw ( CORBA::SystemException )
{
}
...
AssetFactory_impl::createServant(const char* name)
...
void
AssetFactory_impl::list(CORBA::ULong how_many,
...
ServerModule::ServantBase_ptr
AssetFactory_impl::find(const char* name)
...
void
AssetFactory_impl::removeServant(ServerModule::ServantBase_ptr s)
...
void 
AssetFactory_impl::provisioningGui(CORBA::String_out provisioningGui)
...
void 
AssetFactory_impl::statusGui(CORBA::String_out statusGui)
        throw(ServerModule::NoGuiProvisioned,
              ServerModule::UnspecifiedException,
              CORBA::SystemException)
{
...
void 
AssetFactory_impl::setAdminState(ServerModule::AdministrativeState adminState)
...
AssetFactory_impl::getAdminState()
        throw(ServerModule::UnspecifiedException,
              CORBA::SystemException)
{
...
void
AssetFactory_impl::getCreateTime (CORBA::LongLong_out createTime)
        throw (ServerModule::UnspecifiedException, 
...
void
AssetFactory_impl::getLastModifiedTime (CORBA::LongLong_out lastModifiedTime)
        throw (ServerModule::UnspecifiedException, 
               ServerModule::Unimplemented,
               CORBA::SystemException)
{
