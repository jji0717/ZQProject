...
protected:
	...
	HRESULT getConfigValue(wchar_t*cfg_name,DWORD* value,DWORD defaultVal,bool bReport,bool bMan = false);
	//////////////////////////////////////////////////////////////////////////
	/// 
	/// getConfigValue 
	/// retrieve configuration values from register 
	...
	HRESULT getConfigValue(wchar_t*cfg_name,wchar_t* value,wchar_t* defaultVal,DWORD* dwSize,bool bReport,bool bMan = false);
	//////////////////////////////////////////////////////////////////////////
	/// 
	/// getConfigValue 
	/// retrieve configuration values from register 
	...
	/// 	
	//////////////////////////////////////////////////////////////////////////
	HRESULT getConfigValue(wchar_t*cfg_name,bool* value,bool defaultVal,bool bReport,bool bMan = false);
