...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/nPVR/importAlarm/IsaAlarm/ScReporter.h $
// 
...
#define SCREPORTER_DEFAULT_FILESIZE (64*1024)
#define SCREPORTER_DEFAULT_BUFSIZE (4*1024)
#define SCREPORTER_DEFAULT_FLUSH_TIMEOUT (2*1000)
#define SCREPORTER_EXEC_LOG_LEVEL ZQ::common::Log::L_DEBUG
#define SCREPORTER_MIN_FILESIZE (16*1024)
