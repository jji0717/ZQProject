...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/ScheduledTV_old/RtspClient/RtspHeaders.h $
// 
...
#define		RTSP_DISCONNECT 0
#define		RTSP_IDLE		1
#define		RTSP_READY		2
#define		RTSP_PLAYING	3

// timeout definition
#define		DEFAULT_NSEC			3000
#define		DEFAULT_FREQUENCE		1000
#define		DEFAULT_KEEPALIVESEC	300
#define		DEFAULT_KEEPALIVEFAC	500
