...
source = {    'shell.py':           '/usr/lib/python2.7/site-packages/cinderclient/v1/shell.py',
              'volumes.py':         '/usr/lib/python2.7/site-packages/cinderclient/v1/volumes.py',
              'api.py':             '/usr/lib/python2.7/site-packages/cinder/volume/api.py',
              'rpcapi.py':          '/usr/lib/python2.7/site-packages/cinder/volume/rpcapi.py',
              'volume_actions.py':  '/usr/lib/python2.7/site-packages/cinder/api/contrib/volume_actions.py',
              'manager.py':         '/usr/lib/python2.7/site-packages/cinder/volume/manager.py',
              'driver.py':	    '/usr/lib/python2.7/site-packages/cinder/volume/driver.py',
              'fuse.py':	    '/usr/lib/python2.7/site-packages/cinder/volume/drivers/fuse.py'}
