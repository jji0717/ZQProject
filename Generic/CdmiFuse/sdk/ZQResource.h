...
#define ZQ_PRODUCT_NAME			"XOR-Media Aqua Client"
...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": AquaClient"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"AquaClient_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"AquaClient"
#endif // _DEBUG
