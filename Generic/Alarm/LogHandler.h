...
// Revision History:
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/Generic/Alarm/LogHandler.h $
// 
...
// Created.
// 
// 2     05-07-15 16:56 Daniel.wang
// 
// 1     05-07-15 14:53 Daniel.wang
// 
...
#define Log (*(LogHandler::getLogHandler()))
...
public:
	...
	static void setLogHandler(LogHandler* lh = NULL);
