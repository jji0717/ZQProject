...
typedef struct vvx_index_context
{
	...
	int				useIndicatorRecords; // set non-zero if using "indicator" index records
...
EXPORT int vvxWriteIndexHeader(VVX_INDEX_CONTEXT *pContext, PBYTE buffer, int bufferLen, char *pProgramVersionStr);
