...
#define RTF_ABSMAX_SESCOUNT				100
...
#define TRANSPORT_SCR_TO_TS_RATIO		300
#define TRANSPORT_TS_TICKS_PER_SECOND	( TRANSPORT_SCR_TICKS_PER_SECOND / TRANSPORT_SCR_TO_TS_RATIO )
...
#define RTF_OPEN			_open
#define RTF_CLOSE			_close
#define RTF_READ			_read
#define RTF_WRITE			_write
#define RTF_LSEEK			_lseek
#define RTF_LSEEK64			_lseeki64
...
#define RTF_OPEN			open
#define RTF_CLOSE			close
#define RTF_READ			read
#define RTF_WRITE			write
#define RTF_LSEEK			lseek
#define RTF_LSEEK64			lseek64
...
// sequence boundary option enum
typedef enum _RTF_SEQBOUND_OPTION
{
	RTF_SEQBOUND_OPTION_FIXED = 0,
	RTF_SEQBOUND_OPTION_FLEXIBLE,

	RTF_SEQBOUND_OPTION_LIMIT
...
typedef struct _RTF_TRICK_SPEC
{
	...
	BOOL insertPSI;			// insert a copy of the PSI tables into every access unit
	...
	BOOL rateControlVarGOP; // use variable GOP size rate control method
