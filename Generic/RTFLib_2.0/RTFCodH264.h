...
#ifndef _RTF_COD_H264_H
#define _RTF_COD_H264_H 1
...
#define H264_MAX_SPS_COUNT		2	// max # of active and pending sequence parameter sets
#define H264_MAX_PPS_COUNT		2	// max # of active and pending picture parameter sets
...
typedef enum _RTF_CODEC_PPT_H264
{
	RTF_CODEC_PPT_H264_INVALID = 0,

	RTF_CODEC_PPT_H264_I,
	RTF_CODEC_PPT_H264_IP,
	RTF_CODEC_PPT_H264_IPB,
	RTF_CODEC_PPT_H264_SI,
	RTF_CODEC_PPT_H264_SISP,
	RTF_CODEC_PPT_H264_ISI,
	RTF_CODEC_PPT_H264_ISIPSP,
	RTF_CODEC_PPT_H264_ISIPSPB,

} RTF_CODEC_PPT_H264;

// H.264 sequence parameter set structure
typedef struct _RTF_CODEC_SPS_H264
{
	// state info
	BOOL valid;
...
typedef struct _RTF_CODEC_PPS_H264
{
	// state info
	BOOL valid;
	// PPS fields
...
typedef struct _RTF_CODEC_INFO_H264
{
	...
	RTF_CODEC_SPS_H264 sps[ H264_MAX_SPS_COUNT ];
	// active and pending picture parameter sets
	RTF_CODEC_PPS_H264 pps[ H264_MAX_PPS_COUNT ];
