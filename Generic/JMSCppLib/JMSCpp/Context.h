...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/Generic/JMSCppLib/JMSCpp/Context.h $
// 
...
public:
	...
	/// @param userPwd user password for logging in
	Context(const char *pcURL,const char *pcNamingContextFactory,char* userName,char* UserPwd);
