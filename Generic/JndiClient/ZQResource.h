...
#define ZQ_PRODUCT_NAME			"ZQ Generic Components"
...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": JndiClient"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"JndiClient_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"JndiClient"
#endif // _DEBUG
