...
!if "$(THIRDPARTY_HOME)" == ""
THIRDPARTY_HOME		= $(top_srcdir)\ThirdParty

!if "$(AS)" == "ml64"
THIRDPARTY_HOME		= $(top_srcdir)\ThirdParty-x64
!endif
...
SLICE2CPP		= $(bindir)\x86\slice2cpp.exe
SLICE2XSD		= $(bindir)\x86\slice2xsd.exe
SLICE2FREEZE		= $(bindir)\x86\slice2freeze.exe
SLICE2DOCBOOK		= $(bindir)\x86\slice2docbook.exe
...
.rc.res:
	$(RC) /l 0x804 /fo $@ /i "." /i "$(top_srcdir)/config/" $<
