...
namespace SrvrLoad
{
	...
	void String::splitStr(const std::string& cstStr, const std::string split, vector<std::string>& strVect)
	{
		std::string tmp;
		strVect.clear();
	...
	bool String::isInt(const std::string& cstStr)
	{
		std::string::size_type null_pos = -1;
		std::string::size_type find_pos = -1;
		int size = cstStr.size();
	...
	bool String::isNumber(const std::string& cstStr)
	{
		std::string::size_type null_pos = -1;
		std::string::size_type find_pos = -1;
		int size = cstStr.size();
