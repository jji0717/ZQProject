...
void help()
{
	printf("	MQTTAsync_subscribe: <rabbitMqServer><TopicName><UserName><PassWord>\n");
	...
	printf("	  example: tcp://10.15.10.78:1883 \"MQTT Examples\" guest centos \n");
}
