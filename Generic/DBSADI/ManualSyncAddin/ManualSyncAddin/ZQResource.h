...
#define ZQ_PRODUCT_NAME			"SeaChange DBSync Components"
...
#define ZQ_FILE_DESCRIPTION        	"SeaChange DBSync Components ManualSyncAddin App"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"ManualSyncAddin_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"ManualSyncAddin"
#endif // _DEBUG
