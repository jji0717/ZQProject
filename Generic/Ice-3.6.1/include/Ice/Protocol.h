...
inline std::ostream&
operator<<(std::ostream& out1, const ProtocolVersion& version)
{
    return out1 << static_cast<int>(version.major) << "." << static_cast<int>(version.minor);
}

inline std::ostream&
operator<<(std::ostream& out1, const EncodingVersion& version)
{
    return out1 << static_cast<int>(version.major) << "." << static_cast<int>(version.minor);
}
