...
namespace XmlRpc {
 ...
 static const char VALUE_TAG[]     = "<v>";
  ...
  static const char BOOLEAN_TAG[]   = "<b>";
  static const char BOOLEAN_ETAG[]  = "</b>";
  static const char DOUBLE_TAG[]    = "<f>";
  static const char DOUBLE_ETAG[]   = "</f>";
  static const char INT_TAG[]       = "<i>";
  static const char I4_TAG[]        = "<i4>";
  static const char I4_ETAG[]       = "</i4>";
  static const char STRING_TAG[]    = "<s>";
  static const char STRING_ETAG[]    = "</s>";
  static const char EMPSTR_TAG[]     = "<s/>";
  static const char DATETIME_TAG[]  = "<tm>";
  static const char DATETIME_ETAG[] = "</tm>";
  static const char BASE64_TAG[]    = "<b>";
  static const char BASE64_ETAG[]   = "</b>";

  static const char ARRAY_TAG[]     = "<a>";
  static const char DATA_TAG[]      = "<d>";
  static const char DATA_ETAG[]     = "</d>";
  static const char ARRAY_ETAG[]    = "</a>";

  static const char STRUCT_TAG[]    = "<t>";
  static const char MEMBER_TAG[]    = "<m>";
  static const char NAME_TAG[]      = "<k>";
  static const char NAME_ETAG[]     = "</k>";
  static const char MEMBER_ETAG[]   = "</m>";
  static const char STRUCT_ETAG[]   = "</t>";
#else
  ...
  static const char EMPSTR_TAG[]     = "<string/>";
  ...
  bool XmlRpcValue::fromXml(std::string const& valueXml, int* offset)
  {
    ...
    else if (typeTag == EMPSTR_TAG)
	{
		_type = TypeString;
		_value.asString = new std::string("");
//		*offset += strlen(EMPSTR_TAG);
		result = true;
	}
  ...
  {
    std::string xml = VALUE_TAG;
    //xml += STRING_TAG; optional ?? XiaoBai, why it is optional?? -andy
    xml += STRING_TAG;
    xml += XmlRpcUtil::xmlEncode(*_value.asString);
    //xml += STRING_ETAG; ?? XiaoBai, why it is optional?? -andy
    xml += STRING_ETAG; 
    xml += VALUE_ETAG;
    return xml;
  }
  ...
  bool XmlRpcValue::structFromXml(std::string const& valueXml, int* offset)
  {
	  ...
	  const char* cp = valueXml.c_str();
	  const char* ptr = cp + *offset;
