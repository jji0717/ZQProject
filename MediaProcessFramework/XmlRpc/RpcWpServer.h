...
// Revision History:
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/MediaProcessFramework/XmlRpc/RpcWpServer.h $
// 
...
namespace ZQ
{
	namespace rpc
	{
		...
		public:
			...
			bool bindAndListen(int port, const char* strip = 0, int backlog = MAX_BACKLOG_NUMBER);
