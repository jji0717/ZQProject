...
namespace XmlRpc {
  ...
  public:
    ...
    bool bindAndListen(int port, const char* strip = NULL, int backlog = 5);
  ...
  protected:
	  friend class ZQ::rpc::RpcServer;

    //! Accept a client connection request
    virtual void acceptConnection();

    //! Create a new connection object for processing requests from a specific client.
    virtual XmlRpcServerConnection* createConnection(int socket, int type = ST_TCP);
