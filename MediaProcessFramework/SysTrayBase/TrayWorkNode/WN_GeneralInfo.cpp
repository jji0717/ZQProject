// WN_GeneralInfo.cpp : implementation file
//
...
WN_GeneralInfo::WN_GeneralInfo(CWnd* pParent /*=NULL*/)
{
	//{{AFX_DATA_INIT(WN_GeneralInfo)
	m_edCpu = _T("");
	m_edInt = _T("");
	m_edMem = _T("");
	m_edNet = _T("");
...
void WN_GeneralInfo::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(WN_GeneralInfo)
	...
	DDX_Text(pDX, IDC_EDIT1_VER, m_edVer);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(WN_GeneralInfo, CDialog)
	//{{AFX_MSG_MAP(WN_GeneralInfo)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// WN_GeneralInfo message handlers

RpcValue& WN_GeneralInfo::GenRpcValue() 
{
...
void WN_GeneralInfo::UpdateDlgList(RpcValue& _result)
{
	char buf[1024];
...
void WN_GeneralInfo::FormatMemoryStyle(CString& mem)
{
	CString strMem(mem);
	mem.Empty();
