// MN_GeneralInfo.cpp : implementation file
//
...
MN_GeneralInfo::MN_GeneralInfo(CWnd* pParent /*=NULL*/)
	: CInfoDlg(MN_GeneralInfo::IDD, pParent)
{
...
void MN_GeneralInfo::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(MN_GeneralInfo)
...
BEGIN_MESSAGE_MAP(MN_GeneralInfo, CDialog)
	//{{AFX_MSG_MAP(MN_GeneralInfo)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// MN_GeneralInfo message handlers

RpcValue& MN_GeneralInfo::GenRpcValue()
{
...
void MN_GeneralInfo::UpdateDlgList(RpcValue& _result)
{
	char buf[1024];
...
void MN_GeneralInfo::FormatMemoryStyle(CString& mem)
{
	CString strMem(mem);
	mem.Empty();
