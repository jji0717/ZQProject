...
class CMN_ManagedWorkIns : public CDialog
{
// Construction
public:
	CMN_ManagedWorkIns(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CMN_ManagedWorkIns)
	enum { IDD = IDD_DLG_MANAGED_WORKINS };
...
// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CMN_ManagedWorkIns)
	protected:
	virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV support
	//}}AFX_VIRTUAL
