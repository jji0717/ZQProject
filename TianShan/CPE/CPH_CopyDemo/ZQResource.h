...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": Path Helper Object for SeaChange Topologic"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"pho_SeaChange_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"pho_SeaChange"
#endif // _DEBUG
