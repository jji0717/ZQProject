...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentProvisionHelper AquaRec module"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"CPH_AquaRec_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"CPH_AquaRec"
#endif // _DEBUG
