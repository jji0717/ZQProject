...
namespace ZQTianShan{
	...
	class RTINasSess : public ZQTianShan::ContentProvision::BaseCPHSession, public ZQTianShan::ContentProvision::BaseGraph
	{
	public:
		RTINasSess(ZQTianShan::ContentProvision::BaseCPHelper& helper, const ::TianShanIce::ContentProvision::ProvisionSessionExPtr& pSess)
	...
	class RTINasHelper : public ZQTianShan::ContentProvision::BaseCPHelper, ZQTianShan::ContentProvision::MethodCost
	{
	public:
		RTINasHelper(ZQ::common::NativeThreadPool& pool, ZQTianShan::ContentProvision::ICPHManager* mgr);
		virtual ~RTINasHelper();
	...
	public: // impl of ICPHelper
		...
		{
			if (NULL == methodType || (0 != stricmp(METHODTYPE_RTIVSNAS, methodType)))
				return NULL;
			
			return new RTINasSess(*this, pSess);
		}
