...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentProvisionHelper RTIvsVstrm module"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"CPH_RTI_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"CPH_RTI"
#endif // _DEBUG
