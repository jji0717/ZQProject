...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentProvisionHelper NPVRvsVstrm module"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"CPH_NPVR_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"CPH_NPVR"
#endif // _DEBUG
