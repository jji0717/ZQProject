...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentProvisionHelper CPH_Raw module"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"CPH_Raw_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"CPH_Raw"
#endif // _DEBUG
