...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentProvisionHelper CSIvsVstrm module"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"CPH_CSI_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"CPH_CSI"
#endif // _DEBUG
