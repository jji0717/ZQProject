...
namespace ZQTianShan{
	...
	class NasCySess : public ZQTianShan::ContentProvision::BaseCPHSession, public ZQTianShan::ContentProvision::BaseGraph
	{
	public:
		NasCySess(ZQTianShan::ContentProvision::BaseCPHelper& helper, const ::TianShanIce::ContentProvision::ProvisionSessionExPtr& pSess)
	...
	class NasCyHelper : public ZQTianShan::ContentProvision::BaseCPHelper,ZQTianShan::ContentProvision::MethodCost
	{
	public:
		NasCyHelper(ZQ::common::NativeThreadPool& pool, ZQTianShan::ContentProvision::ICPHManager* mgr);
		virtual ~NasCyHelper();
	...
	public: // impl of ICPHelper
		...
		virtual bool getBandwidthLoad(const char* methodType, long& bpsAllocated, long& bpsMax, long& initCost)
		{
			...
			if (NULL == methodType || 0 != stricmp(METHODTYPE_RTIVSVSTRM, methodType))
				return false;
		...
		virtual ZQTianShan::ContentProvision::MethodCost* getMethodCost(const std::string& methodType){ return this;}
		...
		{
			if (NULL == methodType || 0 != stricmp(METHODTYPE_NASCOPYVSVSTRM, methodType))
				return NULL;
			
			return new NasCySess(*this, pSess);
		}
