...
public:
	  ...
	  _ic(ic)
	{
	  ...
	  TianShanIce::Streamer::DataOnDemand::DataStreamPrx operator()(
		const std::string& endPoint, 
		...
		const std::string& name)
	{
		...
		return TianShanIce::Streamer::DataOnDemand::DataStreamPrx::checkedCast(
...
public:
	...
	TianShanIce::Streamer::DataOnDemand::MuxItemPrx operator()(
		const std::string& endPoint, 
		const std::string& space, 
		const std::string& strmName, 
		const std::string& itemName)
	{
		...
		return TianShanIce::Streamer::DataOnDemand::MuxItemPrx::checkedCast(
			createObjectWithEndPoint(_ic, ident, endPoint));
	}
