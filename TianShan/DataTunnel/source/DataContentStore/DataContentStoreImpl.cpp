...
// --------------------------------------------------------------------------------------------
// Revision History: 
// $Header: /ZQProjs/TianShan/DataTunnel/source/DataContentStore/DataContentStoreImpl.cpp 1     10-11-12 16:05 Admin $
// $Log: /ZQProjs/TianShan/DataTunnel/source/DataContentStore/DataContentStoreImpl.cpp $
// 
...
// Created.
// 
// 3     09-12-29 11:58 Li.huang
// 
// 2     09-08-05 15:28 Li.huang
// 
...
#include "DataContentStoreServ.h"
#include "DataContentStoreCfg.h"
...
#define FREEZE_ENV_NAME       "DataContent"
#define FREEZE_ENV_EVICTOR    "DataContentObjs"
...
void DODContentI::setDataWrappingParam(const TianShanIce::Storage::DataOnDemand::DataWrappingParam& param, const ::Ice::Current& current)
{
...
TianShanIce::Storage::ContentPrx DODContentStoreI::openContent(const ::std::string& name, const std::string& destinationContentType, bool createIfNotExist, const ::Ice::Current& current)
{
	...
	if(_evictor->hasObject(ident))
	{
		...
		return TianShanIce::Storage::DataOnDemand::DODContentPrx::uncheckedCast(g_dodCSServ._adapter->createProxy(ident));	
	}
	
	/* needs a new one, then create the servant for this request. possible exception here. */
	DODContentIPtr contentI = new TianShanIce::Storage::DataOnDemand::DODContentI(name, destinationContentType, createIfNotExist);
