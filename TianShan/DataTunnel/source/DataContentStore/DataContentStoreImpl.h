...
// --------------------------------------------------------------------------------------------
// Revision History: 
// $Header: /ZQProjs/TianShan/DataTunnel/source/DataContentStore/DataContentStoreImpl.h 1     10-11-12 16:05 Admin $
// $Log: /ZQProjs/TianShan/DataTunnel/source/DataContentStore/DataContentStoreImpl.h $
// 
...
class DODContentI : public TianShanIce::Storage::DataOnDemand::DODContent, public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
public:
...
public:
	...
	virtual void setDataWrappingParam(const TianShanIce::Storage::DataOnDemand::DataWrappingParam& param, const ::Ice::Current& = ::Ice::Current());
...
private:
	...
	TianShanIce::Storage::DataOnDemand::DataWrappingParam _wrapParam;
	bool                              _paramConfiged;
};
...
//	virtual void listContents_async(const TianShanIce::Storage::AMD_Volume_listContentsPtr &,const TianShanIce::StrValues &,const std::string &,Ice::Int,const Ice::Current &) const;
