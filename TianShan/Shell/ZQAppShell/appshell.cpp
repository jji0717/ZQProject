...
DWORD       fac_mask = SrvShell << 16;  // used by svcsubr.cpp
...
BOOL halted = FALSE;
BOOL bIsServiceMode;	// T - Service mode; F - Interactive
...
{
    app_main( cmd_params.argc, cmd_params.argv );
    return( ERROR );
}
