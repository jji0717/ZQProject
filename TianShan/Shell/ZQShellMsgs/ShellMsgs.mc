;//		 
;// Copyright (c) 2006 by
;// ZQ International Inc., West Concord, Mass.
...
;//
;// title:       AppShellMsgs.MC
;//
;// version:     V0.0
;//
;// facility:    ITV
;//
;// abstract:    This is the AppShell.LIB message file for all appshell related messages.
;//
;// Revision History:
;// -----------------
;//
...
;//  ------ ---------------- -------  -----------------------------------
;//  	   TMS	   Initial message file
;//                                        SPR #947. Added APPSHELL_ON_BACKUP and APPSHELL_NO_WARNING_THREAD
;//                                        SPR #1185. Added APPSHELL_TO_BACKUP
;//
;//
...
;//*    Header Section
;//*
;//*  There will be no typedefs for messages.  The severity names will be the
...
;// Keep the values here the same as they are for CDCIMSGS.h
;//
FacilityNames = (Service_Shell=0x0006:ZQShell
