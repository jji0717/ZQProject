...
**  T3.0    28-Aug-1995     PHB      Bullet-proofing tasks
**  V3.0    02-Oct-1995     FHH      Added constants for Greyhound SDVL
**  V3.0    04-Oct-1995     FHH      Changed constants CFG_GH_CLUSTER, CFG_GH_IU and CFG_GH_MVL from 8, 9, 10 to 9, 10, 11
**  V3.0    12-Oct-1995     BJQ      Moved FM_LOCATE functions into their own header (fm_process.h)
**  V3.0    02-feb-1995     davidr   Merged V2.5 fix of MAXIPADDRLEN from 16->18
**  V3.0    11-feb-1995     CJH      added CFG_MGT definition from V2.5 version
**  V3.1    17-jun-1996     JMB      added CFG_ENTRY_NOT_FOUND and CFG_DLL_NOT_FOUND errors.
**  T3.5    29-Aug-1996	    CJB      DLL Declarations are now made in the .DEF
...
**  T3.5    19-Sep-1996	    CJB      Added CFG_FREE() prototype.
**  T3.5    02-Oct-1996     davidr   Added CFG_STANDALONE (for LES)
**  T3.5    18-Nov-1996     CJB      Added CFG_GH_RVL, CFG_RDB_MASTER, CFG_RDB_SLAVE,
**                                   and CFG_GH_IC system types.
**  T3.5    29-Jan-1997     CJB      Added CFG_GH_AMVL system type, removed
**                                   CFG_RDB_SLAVE.
**  ItvT2   01-Apr-1999     MRK      Added CFG_GET_MGMT_PORT.
**
**  ItvT3   10-21-2006      Tony     Modify the Seachange Key To ZQ
*/
 ...
 */
////modify by dony 2006 change change seachange's unicode  WCHAR to  TCHAR 
	HANDLE CFG_INITEx(TCHAR* app_name, DWORD* num_values, TCHAR* lpszProductName);
/*
 ...
 */
////modify by dony 2006 change change seachange's unicode  WCHAR to  TCHAR 
	CFGSTATUS CFG_SUBKEY(HANDLE handle, TCHAR* subkey, DWORD* num_values);
/*
 ...
 * returns an error.
 */
CFGSTATUS CFG_SUBKEY_EXISTS(HANDLE handle, LPCTSTR subkey);
