...
#define ZQ_PRODUCT_NAME			"ZQ PathSrv&WeiwooSrv Client Admin ActiveX"

#include "../../../build/ZQSrcTreeVer.h" // defines the version number of the source tree


// the following section are static per-project
#define ZQ_FILE_DESCRIPTION        	"ZQ PathSrv&WeiwooSrv Client Admin ActiveX"
#ifdef _DEBUG
#define ZQ_FILE_NAME               	"AdminControl_d.dll"
#define ZQ_INTERNAL_FILE_NAME      	"AdminControl_d"
#else
#define ZQ_FILE_NAME               	"AdminControl.dll"
#define ZQ_INTERNAL_FILE_NAME      	"AdminControl"
#endif
