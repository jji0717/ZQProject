...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": Administration Console for Path Management Service"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"PathAdmin_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"PathAdmin"
#endif // _DEBUG
