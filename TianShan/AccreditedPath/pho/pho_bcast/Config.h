#ifndef _WEIWOO_SERVICE_PLUGIN_BCAST_CONFIG_H__
#define _WEIWOO_SERVICE_PLUGIN_BCAST_CONFIG_H__
...
struct PHOConfig
{
    ...
    PHOConfig()
    {
        strcpy(szPHOLogFileName,"pho_bcast.log");
    }
...
#endif//_WEIWOO_SERVICE_PLUGIN_BCAST_CONFIG_H__
