...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": MediaCluster ContentStore Service"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"MediaClusterCS_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"MediaClusterCS"
#endif // _DEBUG
