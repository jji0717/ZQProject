...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/TianShan/ContentStore/ClusterCS.h $
// 
// 2     12/25/13 5:50p Zonghuan.xiao
...
class ClusterCS : public IDispatchCS
{
public:
	ClusterCS(){}
	ClusterCS(ZQ::common::Log& log, ZQ::common::Log& eventlog, 
