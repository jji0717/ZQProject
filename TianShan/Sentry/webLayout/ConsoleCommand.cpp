// ConsoleCommand.cpp: implementation of the ConsoleCommand class.
//
//////////////////////////////////////////////////////////////////////
...
{
//////////////////////////////////////////////////////////////////////////
//helper class to get console output

class LocalDataBuffer : public IHttpResponse
{
public:
...
#ifdef ZQ_OS_MSWIN
bool ConsoleCommand::execute(DataBuffer &output, const char* pExe, const char* pCmdLine)
{
...
bool ConsoleCommand::execute(DataBuffer &output, const char* pExe, const char* pCmdLine)
{
	...
	if(strchr(chcmd, '/') != NULL)
	{
		...
		{
			glog(Log::L_ERROR,"execute  command line[%s] access  failed error code[%d] string[%s]",
				pCmdLine,errno,strerror(errno));
			return false;
		}
	}
...
bool ConsoleCommand::execute(std::string &output, const char* pExe, const char* pCmdLine)
{
    LocalDataBuffer localbuf;
    if(execute(localbuf, pExe, pCmdLine))
    {
        localbuf.flush(output);
        return true;
    }
    else
    {
