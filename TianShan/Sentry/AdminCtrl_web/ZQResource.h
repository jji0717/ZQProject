...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": AdminCtrl's web extension"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"AdminCtrl_web_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"AdminCtrl_web"
#endif // _DEBUG
