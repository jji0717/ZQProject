...
#define ZQ_FILE_DESCRIPTION     ZQ_PRODUCT_NAME_SHORT ": RTSP plugin for GBss integration, support of eventIS VOD interface 5d"

#ifdef _DEBUG
#  define ZQ_INTERNAL_FILE_NAME   "ssm_GBss_d"
#else
#  define ZQ_INTERNAL_FILE_NAME   "ssm_GBss"
#endif // _DEBUG
