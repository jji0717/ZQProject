...
namespace GBss
{
	...
	class PauseHandlerCB : public IceUtil::Shared
	{
	public:
		PauseHandlerCB(PauseHandler::Ptr pHandler) {
		}
	private:
	...
	typedef IceUtil::Handle<PauseHandlerCB> PauseHandlerCBPtr;
#else
...
RequestProcessResult PauseHandler::doContentHandler()
{
	...
	{
#if ICE_INT_VERSION / 100 >= 306
			PauseHandlerCBPtr PauseHCbPtr = new PauseHandlerCB(this);
			Ice::CallbackPtr genericCB = Ice::newCallback(PauseHCbPtr, &PauseHandlerCB::pauseEx);
