...
{
public:
    HttpResponse(ZQ::eloop::HttpMessage::Ptr req,ZQ::eloop::HttpPassiveConn& conn);
...
private:
    void send();
private:
	ZQ::eloop::HttpMessage::Ptr _resp;
	ZQ::eloop::HttpPassiveConn& _conn;
...
{
public:
	HttpRequestCtx(const ZQTianShan::Sentry::SentryEnv& env,ZQ::eloop::HttpPassiveConn& conn,const ZQ::eloop::HttpMessage::Ptr req);
