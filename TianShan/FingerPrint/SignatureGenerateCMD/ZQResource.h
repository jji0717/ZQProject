...
#include "../../../build/ZQSrcTreeVer.h" // defines the version number of the source tree
	...
	#define ZQ_PRODUCT_NAME			"ZQ TianShan tslicapp"

	#define ISA_TARGET_ENV          	VOD_VERSION_DESC "; ITV " ITV_VERSION

	// the following section are static per-project
	#define ZQ_FILE_DESCRIPTION        	"ZQ TianShan Components tslicapp"
	#ifdef _DEBUG
		#define ZQ_INTERNAL_FILE_NAME      	"tslicapp_d"
	#else
		#define ZQ_INTERNAL_FILE_NAME      	"tslicapp"
	#endif // _DEBUG
