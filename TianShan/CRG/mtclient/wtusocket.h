#ifndef __WTUSOCKET_DEFINE__H_
#define  __WTUSOCKET_DEFINE__H_
#include <WinSock2.h>  
#include <string>  
#include <stdio.h>
#include <errno.h>
...
//extern enum TypeSocket {BlockingSocket, NonBlockingSocket};  
...
public:  
	virtual ~SocketU();  
	void   CloseU();  
	int   SendBinaryU(struct sockaddr_in& peer_addr,char* pdata,ULONG slen,bool fs1,bool fs2);
	int   RecvBinaryU(struct sockaddr_in& peer_addr,char* pdata,ULONG slen,bool fs1,bool fs2);
protected:  
...
// --client class
class SocketClientU : public SocketU {  
public:  
	SocketClientU();
