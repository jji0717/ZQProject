...
protected:
	DsmccMsg(HardHeader& hardHeader);
    virtual ~DsmccMsg();
...
public:
	ClientSessionSetupRequest(HardHeader& hardHeader):DsmccMsg(hardHeader){
...
public:
	ClientSessionSetupConfirm(HardHeader& hardHeader);
...
public:
	ClientSessionRelease(HardHeader& hardHeader):DsmccMsg(hardHeader){
		memset(&_minBody, 0 , sizeof(_minBody));
	};
...
{
public:
	ClientSessionReleaseRequest(HardHeader& hardHeader):ClientSessionRelease(hardHeader){};
...
{
public:
	ClientSessionReleaseConfirm(HardHeader& hardHeader):ClientSessionRelease(hardHeader){};
...
{
public:
	ClientSessionReleaseIndication(HardHeader& hardHeader):ClientSessionRelease(hardHeader){};
...
{
public:
	ClientSessionReleaseResponse(HardHeader& hardHeader):ClientSessionRelease(hardHeader){};
...
public:
	ClientSessionProceedingIndication(HardHeader& hardHeader):DsmccMsg(hardHeader){
	memset(&_minBody, 0 , sizeof(_minBody));
	};
...
public:
	ClientSessionInProgressRequest(HardHeader& hardHeader):DsmccMsg(hardHeader){
		sessionIds.clear();
	};
