...
int LAMPlayListQuery::GetPlayListFromILAMFacade(PlayListInfo& plinfo, AEReturnData& aedata)
{
	...
	try
	{
		...
		MLOG(ZQ::common::Log::L_INFO, CLOGFMT(LAMPlayListQuery, "[%s]get LAMFacade proxy took %d ms and get playlist from LAMFacade mode successfully [took %d ms]"),
	...
	MLOG(ZQ::common::Log::L_DEBUG, CLOGFMT(LAMPlayListQuery, "[%s] Leave GetPlayListFromILAMFacade()"), plinfo.ident.name.c_str());
