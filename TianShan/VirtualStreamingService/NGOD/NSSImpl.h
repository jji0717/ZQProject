...
typedef struct SessionGroup
{
	::std::string	name;
	int32			maxSession;
	typedef ::std::list<SessionGroup> Groups;
}SessionGroup;
...
public:
	...
	void calcScale(::Ice::Float &fScale);
	void renewPathTicket(const ::Ice::Current&);
	void setItemInfo(::TianShanIce::Streamer::NGODStreamServer::stItem &item, ::Ice::Int userCtrlNum, const ::TianShanIce::Streamer::PlaylistItemSetupInfo& newItemInfo, ::Ice::Int whereUserCtrlNum);
...
public: 
	...
	virtual ::std::string getC1ConnectionUrl(const ::Ice::Current& c) const;
...
public:
	...
	virtual void playEx_async(const ::TianShanIce::Streamer::AMD_Stream_playExPtr& amd,
							   ...
							   throw (::TianShanIce::ServerError,
							   ::TianShanIce::InvalidStateOfArt);
	virtual ::TianShanIce::Streamer::StreamInfo playEx(::Ice::Float newSpeed, 
		::Ice::Long timeOffset,
		::Ice::Short from,
		const ::TianShanIce::StrValues& expectedProps,
		const ::Ice::Current& c)
	...
	virtual ::TianShanIce::Streamer::StreamInfo pauseEx(const ::TianShanIce::StrValues& expectedProps, 
														const ::Ice::Current&)
														throw (::TianShanIce::ServerError, 
														::TianShanIce::InvalidStateOfArt);
...
class NGODStreamServiceImpl : public TianShanIce::Streamer::NGODStreamServer::NGODStreamService, public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
public:
