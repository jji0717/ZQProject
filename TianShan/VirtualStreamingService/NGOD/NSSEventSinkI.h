#ifndef __NSSEVENTSINKI_H__
#define __NSSEVENTSINKI_H__
...
class NSSEventSinkI : public ::ZQ::common::NativeThread
{
public:
	NSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint);
	NSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint, ZQADAPTER_DECLTYPE  adpater);
	~NSSEventSinkI();
