#ifndef __HSNTree_Environment_H__
#define __HSNTree_Environment_H__
...
#  define TS_ANNOUNCE_PING					""
	...
	public:
		...
		bool renewWeiwooSession(const TianShanIce::SRM::SessionPrx& srvrSessPrx, const std::string& srvrSessPrxID, const __int64& rn_time);
...
#endif // __HSNTree_Environment_H__
