...
#ifndef __ZQTianShan_PathHelper_Cisco_H__
#define __ZQTianShan_PathHelper_Cisco_H__
...
#define STRMLINK_TYPE_CISCO		"SeaChange.VSS.Cisco"
#define CiscoTotalBandwidth		"TotalBandwidth"
#define CiscoMaxStreamCount		"MaxStreamCount"

class PHOCisco : public ::Ice::LocalObject, public IStreamLinkPHO
{
public:

	PHOCisco(IPHOManager& mgr);
	virtual ~PHOCisco();
...
#endif //__ZQTianShan_PathHelper_Cisco_H__
