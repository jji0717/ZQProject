...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/TianShan/VirtualStreamingService/Cisco/CVSSEnv.cpp $
// 
// 2     1/02/14 5:57p Hui.shao
// removed NullLogger
// 
...
_cvssEventSinkI(filelog, iceStormEndpoint)
{
	...
	{
		//initialize adapter
		_adapter = ZQADAPTER_CREATE(_communicator, DBFILENAME_CVSSSession, _endpoint.c_str(), glog);
		//_adapter = _communicator->createObjectAdapterWithEndpoints(DBFILENAME_CVSSSession, _endpoint.c_str());
