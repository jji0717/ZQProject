#ifndef __ZQTianShan_VLCVSSEventSinkI_H__
#define __ZQTianShan_VLCVSSEventSinkI_H__
...
class VLCVSSEventSinkI : public ::ZQ::common::NativeThread
{
public:
	VLCVSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint);
	VLCVSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint, ZQADAPTER_DECLTYPE  adpater);
	~VLCVSSEventSinkI();
...
#endif __ZQTianShan_VLCVSSEventSinkI_H__