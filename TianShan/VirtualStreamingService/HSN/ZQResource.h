...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ":HSN Tree Machine Virtual Streaming Service"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"TMVSS_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"TMVSS"
#endif // _DEBUG
