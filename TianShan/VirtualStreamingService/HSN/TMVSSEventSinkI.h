#ifndef __TMVSSEventSinkI_H__
#define __TMVSSEventSinkI_H__
...
class TMVSSEventSinkI : public ::ZQ::common::NativeThread
{
public:
	TMVSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint);
	TMVSSEventSinkI(::ZQ::common::FileLog &fileLog, const char * topicManagerEndpoint, ZQADAPTER_DECLTYPE  adpater);
	~TMVSSEventSinkI();
