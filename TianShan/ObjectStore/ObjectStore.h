...
// Revision History: 
// ---------------------------------------------------------------------------
// $Log: /ZQProjs/TianShan/ObjectStore/ObjectStore.h $
// 
...
#  endif
#  pragma comment(lib, "ice"     LIB_SUFFIX)
#  pragma comment(lib, "iceutil" LIB_SUFFIX)

#undef  OBJECTSTORE_API
#ifdef ObjectStore_EXPORTS
#  define OBJECTSTORE_API __declspec(dllexport)
#else
#  define OBJECTSTORE_API __declspec(dllimport)
#endif
...
#define POINTER     ::IceUtil::Handle
#define SOBJECT     ::Ice::Object
#define SLOCALOBJ   ::Ice::LocalObject

// typedef std::vector < Ice::Identity > Identities;
typedef std::vector < std::string >   StringList;
typedef StringList Identities;

typedef ::Ice::Object  ObjectServant;
typedef Ice::ObjectPtr ServantPtr;
typedef POINTER< SLOCALOBJ > LocalObjectPtr;

class OBJECTSTORE_API Index;
class OBJECTSTORE_API ObjectIterator;
class OBJECTSTORE_API ObjectStoreException;
class OBJECTSTORE_API AlreadyExists;
class OBJECTSTORE_API NotFound;
class OBJECTSTORE_API BadRecord;
class OBJECTSTORE_API ObjectStore;
