...
#define GETPARA_MINCACHESIZE	2000
	...
	public:
		...
		//typedef ZQ::common::LRUMap<std::string,TianShanIce::Events::GenericEventSinkPrx> GenericEventSinkPrxMap;
		typedef std::map<std::string,TianShanIce::Events::GenericEventSinkPrx> GenericEventSinkPrxMap;
	public:
		...
		bool		subscribe( );
		bool		publish(const std::string& topicName, const std::string& category, int eventId, const std::string& eventName, const TianShanIce::Properties& params);
