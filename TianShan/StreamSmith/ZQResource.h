...
#define ZQ_PRODUCT_COMMENT          	ZQ_PRODUCT_NAME " " ZQ_PRODUCT_VER_STR3 " for SeaChange VstreamKit " __xN2S__(VER_PRODUCTVERSION_MAJOR) "." __xN2S__(VER_PRODUCTVERSION_MINOR) "." __xN2S__(VER_PRODUCTVERSION_ECO)
