...
//StreamProgressSinkI::StreamProgressSinkI(EventSenderManager& ssMan):mEventManager(ssMan)
//{
//}
...
StreamEventSinkI ::StreamEventSinkI(EventSenderManager& ssMan):mEventManager(ssMan)
{
}
...
PlaylistEventSinkI::PlaylistEventSinkI(EventSenderManager& ssMan):mEventManager(ssMan)
{	
