...
#ifndef __tianshan_siteadmin_environment_header_file_h__
#define __tianshan_siteadmin_environment_header_file_h__
...
struct PerformanceTuneCfg
{
	PerformanceTuneCfg()
	{
		lAppMountEvictorSize	= 100;
		lTxnEvictorSize			= 2000;
		lTxnEventEvictorSize	= 1000;
	}
	...
	int32			lAppMountEvictorSize;
	int32			lTxnEvictorSize;
	int32			lTxnEventEvictorSize;

	static void structure( ZQ::common::Config::Holder<PerformanceTuneCfg> &holder )
	{
		using namespace ZQ::common::Config;
		holder.addDetail("IceFreezeEnviroment","CheckpointPeriod",&PerformanceTuneCfg::strCheckpointPeriod,	"240",optReadOnly);
		holder.addDetail("IceFreezeEnviroment","DbRecoverFatal",&PerformanceTuneCfg::strDbRecoverFatal,"1",optReadOnly);
		holder.addDetail("LiveTxn","SavePeriod",&PerformanceTuneCfg::strLivTxnSavePeriod,"240",optReadOnly);
		holder.addDetail("LiveTxn","SaveSizeTrigger",&PerformanceTuneCfg::strLivTxnSaveSizeTrigger,"10000",optReadOnly);
	}
};
...
struct SAConfig
{
	...
	int32			lIceTraceLogBuffer;
	int32			lIceTraceLogTimeout;
	...
	static void structure(ZQ::common::Config::Holder<SAConfig> &holder)
	{
		...
		holder.addDetail("default/IceTrace", "level", &SAConfig::lIceTraceLogLevel, "7", optReadOnly);
...
public:
	...
	inline ZQ::common::Config::Loader<SAConfig>&	getConfig()
	{
		return *mSaConfig;
	}
...
public:
	...
	ZQ::common::NativeThreadPool*			mMainThreadpool;
	ZQ::common::Config::Loader<SAConfig>* 	mSaConfig;
...
#endif//__tianshan_siteadmin_environment_header_file_h__
