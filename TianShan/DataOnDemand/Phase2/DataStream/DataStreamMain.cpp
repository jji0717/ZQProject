...
//////////////////////////////////////////////////////////////////////////
/*
class DataStreamConfig: public ZQLIB::ConfigLoader
{
public:
	DataStreamConfig();
...
{
	setConfigFileName("DataStreamCfg.xml");
}

DataStreamConfig::ConfigSchemaItem* DataStreamConfig::getSchema()
{
	::DataStream::DataConfig& cfg = dataConfig;

	static DataStreamConfig::ConfigSchemaItem configs[] = {
		
		
		// log
		{"DataStream/Log", "logFile", cfg.logFile, sizeof(cfg.logFile), 
			true, ConfigSchemaItem::TYPE_STRING}, 

		{"DataStream/Log", "logFileSize", &cfg.logFileSize, 
			sizeof(cfg.logFileSize), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/Log", "logLevel", &cfg.logLevel, 
			sizeof(cfg.logLevel), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 
		

		// thread pool
		{"DataStream/ThreadPool", "readerThreadPoolMinSize", 
			&cfg.readerThreadPoolMinSize, 
			sizeof(cfg.readerThreadPoolMinSize), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 
		
		{"DataStream/ThreadPool", "readerThreadPoolMaxSize", 
			&cfg.readerThreadPoolMaxSize, 
			sizeof(cfg.readerThreadPoolMaxSize), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 
		
		{"DataStream/ThreadPool", "senderThreadPoolMinSize", 
			&cfg.senderThreadPoolMinSize, 
			sizeof(cfg.readerThreadPoolMinSize), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/ThreadPool", "senderThreadPoolMaxSize", 
			&cfg.senderThreadPoolMaxSize, 
			sizeof(cfg.readerThreadPoolMaxSize), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "totalRate", &cfg.totalRate, 
			sizeof(cfg.totalRate), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "higherPriority", &cfg.higherPriority, 
			sizeof(cfg.higherPriority), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "catchDir", cfg.catchDir, 
			sizeof(cfg.catchDir), true, ConfigSchemaItem::TYPE_STRING}, 
			
		{"DataStream/System", "checkStreamTimeout", &cfg.checkStreamTimeout, 
			sizeof(cfg.checkStreamTimeout), true, 
			ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "netId", cfg.netId, 
			sizeof(cfg.netId), true, ConfigSchemaItem::TYPE_STRING}, 
			
		{"DataStream/System", "stdPeriod", &cfg.stdPeriod, 
			sizeof(cfg.stdPeriod), true, ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "stdMaxQueue", &cfg.stdMaxQueue, 
			sizeof(cfg.stdMaxQueue), true, ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/System", "stdMinQueue", &cfg.stdMinQueue, 
			sizeof(cfg.stdMinQueue), true, ConfigSchemaItem::TYPE_INTEGER}, 

		{"DataStream/NetWork", "netWorkCard", &cfg.netWorkcardIP, 
			sizeof(cfg.netWorkcardIP), true, ConfigSchemaItem::TYPE_STRING}, 

		{"DataStream/IceProperties", "prop", NULL, 0, true, 
			ConfigSchemaItem::TYPE_ENUM}, 

		{NULL, NULL, NULL, 0, true, ConfigSchemaItem::TYPE_INTEGER}, 
	};
