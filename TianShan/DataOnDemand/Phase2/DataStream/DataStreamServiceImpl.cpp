...
DataStreamServiceImpl::DataStreamServiceImpl(Ice::ObjectAdapterPtr& adapter):
	_adapter(adapter)
{
	_destroy = false;
	_rateCount = 0;
...
DataStreamServiceImpl::listStrems(const std::string& space, 
	...
	const ::Ice::Current&)
{
	...
	DataStreamImpl* strm = 
		new DataStreamImpl(_adapter, this, space);
...
void 
DataStreamServiceImpl::setProperies(
