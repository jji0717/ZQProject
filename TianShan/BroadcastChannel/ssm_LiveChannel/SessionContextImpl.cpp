...
namespace LiveChannel {
	...
	::LiveChannel::SessionData SessionContextImpl::getSessionData(const ::Ice::Current&)
	{
		::IceUtil::Mutex::Lock lk(*this);

		::LiveChannel::SessionData data;

		data.ident = ident;
		data.streamID = streamID;
		data.streamPrxID = streamPrxID;
		data.purchasePrxID = purchasePrxID;
		data.bcastPublishPointPrxID = bcastPublishPointPrxID;
