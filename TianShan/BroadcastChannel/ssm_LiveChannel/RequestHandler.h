...
#define ClientRequestPrivateDataPrefix "ClientRequest."
	...
	protected: static std::string _dummyLastSessId;
	...
	public: 
		...
		virtual std::string eventParamLine() const { return ""; };
...
#define		LAST_SCALE_STATUS_INDEX_BK			SYS_PROP(LastScaleStatusIndex_backup)
	...
	protected: 		
		...
		TianShanIce::Application::Broadcast::BcastPublishPointPrx	_bcastPublishPointPrx;
