#ifndef _Live_Channel_Config_H
#define _Live_Channel_Config_H
...
//<BcastPublish endpoint="assetID@serviceGroup" />
struct BcastPublish
{
	std::string _endpoint;

	typedef ZQ::common::Config::Holder<BcastPublish> BcastPublishHolder;

	static void structure(BcastPublishHolder& holder);
};
typedef BcastPublish::BcastPublishHolder BcastPublishHolder;
...
struct LiveChannelConfig
{
	...
	BcastPublishHolder	_bcastPublish;
	BindHolder _bind;
	...
	typedef ZQ::common::Config::Holder<LiveChannelConfig> LiveChannelConfigHolder;

	static void structure(LiveChannelConfigHolder& holder);
	...
	void readBcastPublish(ZQ::common::XMLUtil::XmlNode node, const ZQ::common::Preprocessor* hPP);

	void registerBcastPublish(const std::string &full_path);
...
extern ZQ::common::Config::Loader<LiveChannel::LiveChannelConfig> _liveChannelConfig;

#endif // #define _Live_Channel_Config_H
