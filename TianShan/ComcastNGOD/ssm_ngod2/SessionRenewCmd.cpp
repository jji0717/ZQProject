...
SessionRenewCmd::SessionRenewCmd(NGODEnv& env, const std::string& cltSessID, const std::string& srvrSessID, const ::Ice::Long newExpiration, const ::Ice::Long oldExpiration)
