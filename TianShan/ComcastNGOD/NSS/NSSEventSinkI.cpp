...
bool NSSEventSinkI::connectToStormService()
{
	try
	{
		...
		MYLOG(::ZQ::common::Log::L_DEBUG,CLOGFMT(NSSEventSinkI, "connect to ice storm service %s successfully!"),_strTopicProxy.c_str());
	}
	...
	{
		MYLOG(::ZQ::common::Log::L_ERROR,CLOGFMT(NSSEventSinkI, "Connect to Ice Storm service %s failed"),_strTopicProxy.c_str());
		return false;
	}
	_bNetworkOK=true;
	return true;
