...
OptionHandler::OptionHandler(ssmNGODr2c1& ssm, IStreamSmithSite* pSite, IClientRequestWriter* pReq) : RequestHandler(ssm, pSite, pReq)
{
	_method = "OPTION";
...
RequestProcessResult OptionHandler::process()
{
	...
	snprintf(szBuf, MY_BUFFER_SIZE - 1, "DESCRIBE, GET_PARAMETER, OPTIONS, SETUP, TEARDOWN, PLAY, PAUSE");
