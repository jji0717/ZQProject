...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": Site Administration service"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"SiteAdminSvc_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"SiteAdminSvc"
#endif // _DEBUG
