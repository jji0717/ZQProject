...
if not exist Components4RTF.V1.6 mkdir Components4RTF.V1.6
cd Components4RTF.V1.6
...
xcopy /fsi *.pdb ..\TianShanSymbols\Components4RTF.V1.6

del /s *.pdb 

del /q/f  ..\Components4RTF.V1.6.zip

%PACKCMD% -r ..\Components4RTF.V1.6.zip .

rem pause

cd ..
rd /s/q Components4RTF.V1.6
