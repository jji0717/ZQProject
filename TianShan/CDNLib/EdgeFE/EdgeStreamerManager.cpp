...
bool CdnStreamerManager::setC2Conf( C2Streamer::C2StreamerEnv& c2env ) {
	...
	conf.sesslogfilename = gEdgeFEConfig.sesslogfilename;
	conf.sesslogfiledirectory = gEdgeFEConfig.sesslogfiledirectory;
	conf.maxsesslognum = gEdgeFEConfig.maxsesslognum;
	conf.sesslogmgrloopInterval = gEdgeFEConfig.sesslogmgrloopInterval;
	conf.sessStatReportInterval = gEdgeFEConfig.sessStatReportInterval;
	conf.sesslogmgrsessExpire = gEdgeFEConfig.sesslogmgrsessExpire;
	conf.stateSwitchInterval = gEdgeFEConfig.stateSwitchInterval;
	conf.LastFramePos = gEdgeFEConfig.LastFramePos;
	conf.enableC2ClientHybrid = gEdgeFEConfig.c2StreamerConfig.enableC2ClientHybrid != 0;
	conf.c2HybridMaxHitCount = gEdgeFEConfig.c2StreamerConfig.c2HybridMaxHitCount;
	conf.c2HybridMaxTimeDuration = gEdgeFEConfig.c2StreamerConfig.c2HybridMaxTimeDuration;
	conf.cacheLocateMaxPending = gEdgeFEConfig.c2StreamerConfig.locateMaxPending;
	...
	c2CacheCenter.calcCRCForBuffer = confCacheCenter.enableCRCcheck;
	...
	c2Client.C2ClientMaxBitrate = gEdgeFEConfig.c2StreamerConfig.c2client.C2ClientMaxBitrate;
...
{
	if( (event->portState == C2Streamer::PORT_STATE_UP) && (event->portAddressV4.empty() || emptyStringArray( event->portAddressV4 ) ) ) {
