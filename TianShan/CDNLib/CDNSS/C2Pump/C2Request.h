...
namespace StreamService{
    ...
    public:
        ...
        virtual void onRead( const std::vector<C2Streamer::BufferUser>& bufs) = 0;
    ...
    public:
        ...
        SLABPOOL_DEFINE(C2ReadFile)

    public:
        bool    addBuffer( const std::vector<C2Streamer::BufferUser>& bufs );
        int     getInstanceID();
    ...
    private:      
        ...
        std::vector<C2Streamer::BufferUser>   _readerBufs;
