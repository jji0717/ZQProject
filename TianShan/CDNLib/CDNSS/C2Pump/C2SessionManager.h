...
public:
	...
	void 				updateSess2Path(const std::string& sess, const std::string& path);

	std::string			getPathFromSess(const std::string& sess);
...
protected:
	...
	typedef ZQ::common::LRUMap<std::string, std::string> Session2FilePathMap;
	Session2FilePathMap 	mSess2Path;
