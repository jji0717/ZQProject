...
class C2StreamerEnv;
class C2Session;
class C2UdpInfoQuery;

typedef ZQ::common::Pointer<C2Session> C2SessionPtr;
typedef ZQ::common::Pointer<C2UdpInfoQuery> C2UdpInfoQueryPtr;
...
public:
	...
	inline SessLogMgr&          getSessLogMgr();
...
SessLogMgr& C2Service::getSessLogMgr()
{
	return mSessLogMgr; 
}
