...
protected:
	...
	Ice::Long       calculateVideoDuration( iter itFirst, iter itLast);

	bool            checkRestriction(constIter itTarget, const long mask);

	int32           getCurrentPlaylistNpt();

	int32           getCurrentItemNpt();
