...
const char* const	EVENT_ITEMSTEP_PREV_ITEM_DUR		  	= "EventStep-ItemPreviousDuration";
const char* const	EVENT_ITEMSTEP_PREV_ITEM_FLAGS       	= "EventStep-ItemPreviousFlags";
...
const char* const	EVENT_ITEMSTEP_CUR_ITEM_DUR		    	= "EventStep-ItemCurrentDuration";
const char* const	EVENT_ITEMSTEP_CUR_ITEM_FLAGS       	= "EventStep-ItemCurrentFlags";
