...
#define ZQ_PRODUCT_NAME			"ZQInfoClientControl ActiveX"

// the following section are static per-project
#define ZQ_FILE_DESCRIPTION        	"ZQInfoClientControl ActiveX"
#ifdef _DEBUG
#define ZQ_FILE_NAME               	"ZQInfoClientControl_d.dll"
#define ZQ_INTERNAL_FILE_NAME      	"ZQInfoClientControl_d"
#else
#define ZQ_FILE_NAME               	"ZQInfoClientControl.dll"
#define ZQ_INTERNAL_FILE_NAME      	"ZQInfoClientControl"
#endif
